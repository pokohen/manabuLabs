...
import { QuestionCount } from './VerbConjugationQuiz'

interface VerbConjugationQuizSetupProps {
  onStart: (config: { questionCount: QuestionCount }) => void
  onBack: () => void
}

export default function VerbConjugationQuizSetup({ onStart, onBack }: VerbConjugationQuizSetupProps) {
